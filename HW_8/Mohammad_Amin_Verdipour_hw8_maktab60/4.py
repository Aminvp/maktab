...
def func(txt):#تابعی که یک متن دریافت میکند و درون متن بررسی میکند که اگر عبارات مورد نظر داخل متن بودند پیغام شد میدهد در غیر اینصورت پیغام پیدا نشد میدهد
